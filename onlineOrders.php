   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="onlineOrders.html" class="nav-link active">
                   ...
                   <tr>
                     ...
                     <td>
                       <div class="row">
                         ...
                         <div class="col-md-8">
                           500Ml Cola-Cola Fanta
                         </div>
                         <div class="col-md-4">
                           x 5
                         </div>
                         <div class="col-md-8">
                           <a href="javascript:void(0)" class="btn btn-sm btn-danger float-left ">Cancel Order</a>
                         </div>
                         <div class="col-md-4 ">
                                <a href="javascript:void(0)" class="btn btn-sm btn-info float-right">Accept Order</a>
                         </div>
                        </div>
                     </td>

                     <td>
                       <div class="sparkbar" data-color="#00a65a" data-height="20"> <b> R135,00 </b> </div>
                     </td>
                   </tr>

                   <tr>
                     <td><a href="pages/examples/invoice.html">OR9826</a></td>
                     <td>
                       <div class="row">
                         <!-- Left col -->
                         <div class="col-md-8">
